    ...
    summary = BenchmarkSummary(
        results=(
            BenchmarkCaseResult(
                ...
                memory_recall=BenchmarkMetric(name="memory_recall", score=1.0, passed=True),
                confidence_citations=BenchmarkMetric(
                    name="confidence_citations",
                    score=1.0,
                    passed=True,
                ),
                latency=BenchmarkMetric(name="latency", score=1.0, passed=True),
                overall_score=1.0,
                passed=True,
        ...
        average_memory_recall=0.7,
        average_confidence_citations=0.7,
        average_latency_score=0.7,
