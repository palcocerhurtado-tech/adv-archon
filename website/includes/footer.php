...
<footer class="site-footer">
  <div class="container">
    <div class="footer-grid">
      ...
      <div class="footer-brand">
        ...
        <div class="footer-social">
          <a href="https://www.instagram.com/micropigmentacionzgz" target="_blank" rel="noopener" aria-label="Instagram">
          ...
          <a href="https://www.facebook.com/micropigmentacionzgz" target="_blank" rel="noopener" aria-label="Facebook">
      ...
      <div class="footer-col">
        <h5>Estudio</h5>
        <ul>
          <li><a href="/quienes-somos.php">Virginia Aguilera</a></li>
          <li><a href="/trabajos-cejas.php">Galería de trabajos</a></li>
    ...
    <div class="footer-bottom">
      <p>&copy; <?= date('Y') ?> Virginia Aguilera — Micropigmentación Zaragoza. Todos los derechos reservados.</p>
      <div>
...
<script type="application/ld+json">
{
  ...
  "email": "info@micropigmentacionzgz.es",
  ...
  "sameAs": [
    "https://www.instagram.com/micropigmentacionzgz",
    "https://www.facebook.com/micropigmentacionzgz"
  ],
  "hasOfferCatalog": {
    "@type": "OfferCatalog",
