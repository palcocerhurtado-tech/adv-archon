<?php
$pageTitle    = 'Micropigmentación Zaragoza — Virginia Aguilera | Cejas, Ojos y Labios';
$pageDesc     = 'Especialista en micropigmentación de cejas, ojos y labios en Zaragoza. Microblading, eyeliner permanente y labios perfectos. Primera consulta gratuita. 620 834 002.';
$pageKeywords = 'micropigmentación Zaragoza, microblading Zaragoza, cejas permanentes Zaragoza, eyeliner permanente Zaragoza, micropigmentación labios Zaragoza, Virginia Aguilera';
$pageImage    = 'https://micropigmentacionzgz.es/img/micropigmentacion-virginia.jpg';
$canonicalUrl = 'https://micropigmentacionzgz.es/';
  ...
  <div class="container">
    <div class="hero-content">
      ...
      <div class="hero-actions">
        ...
        <a href="/trabajos-cejas.php" class="btn btn--outline" style="border-color:rgba(255,255,255,0.6);color:#fff">Ver trabajos</a>
      </div>
    </div>
  </div>
    ...
    <div class="services-grid">
      <div class="service-card reveal reveal-delay-1">
        <img class="service-card-img"
             src="/img/micropigmentacion-cejas.jpg"
        ...
        <div class="service-card-body">
          ...
          <a href="/micropigmentacion-cejas.php" class="btn btn--outline" style="border-color:rgba(255,255,255,0.5);color:#fff">Saber más</a>
        </div>
      </div>

      <div class="service-card reveal reveal-delay-2">
        <img class="service-card-img"
             src="/img/micropigmentacion-ojos.jpg"
        ...
        <div class="service-card-body">
          ...
          <a href="/micropigmentacion-ojos.php" class="btn btn--outline" style="border-color:rgba(255,255,255,0.5);color:#fff">Saber más</a>
        </div>
      </div>

      <div class="service-card reveal reveal-delay-3">
        <img class="service-card-img"
             src="/img/micropigmentacion-labios.jpg"
        ...
        <div class="service-card-body">
          ...
          <a href="/micropigmentacion-labios.php" class="btn btn--outline" style="border-color:rgba(255,255,255,0.5);color:#fff">Saber más</a>
        </div>
      </div>
    </div>
  </div>
  ...
  <div class="container">
    <div class="badges-row reveal">
      <div class="badge-item">
        <img src="/img/sello-de-calidad-negro.png" alt='Sello "Perfecta Micro" AMME' loading="lazy">
  ...
  <div class="container">
    ...
    <div class="gallery-grid">
      <div class="gallery-item reveal reveal-delay-1">
        <img src="/img/trabajos/cejas/microblading-cejas-zaragoza2.jpg"
      ...
      <div class="gallery-item reveal reveal-delay-2">
        <img src="/img/trabajos/labios/labios1.jpg"
      ...
      <div class="gallery-item reveal reveal-delay-3">
        <img src="/img/trabajos/cejas/cejas1.jpg"
      ...
      <div class="gallery-item reveal reveal-delay-4">
        <img src="/img/trabajos/ojos/micropigmentacion-ojos-antes-y-despues.jpg"
    ...
    <div class="gallery-cta reveal">
      <a href="/trabajos-cejas.php" class="btn btn--outline">Ver todos los trabajos</a>
    </div>
  </div>
</section>
  ...
  <div class="container">
    <div class="content-grid">
      <div class="content-img reveal">
        <img src="/img/virginia-aguilera-micropigmentacion.jpg"
  ...
  <div class="container">
    <div class="reveal">
      ...
      <div class="cta-actions">
        ...
        <a href="/contacto.php" class="btn btn--white">Formulario de contacto</a>
      </div>
    </div>
  </div>
</section>
