<?php
$pageTitle    = 'Microblading Zaragoza — Cejas Pelo a Pelo Hiperrealistas | Virginia Aguilera';
$pageDesc     = 'Microblading en Zaragoza con resultados hiperrealistas pelo a pelo. Técnica manual, aspecto 100% natural. Duración de 1 a 3 años. Consulta gratuita. 620 834 002.';
$pageKeywords = 'microblading Zaragoza, microblading cejas Zaragoza, cejas pelo a pelo Zaragoza, técnica manual cejas, microblading natural Zaragoza';
$pageImage    = 'https://micropigmentacionzgz.es/img/microblading-proceso.jpg';
$canonicalUrl = 'https://micropigmentacionzgz.es/microblading-zaragoza.php';
include 'includes/header.php';
?>

<!-- PAGE HERO -->
<section class="page-hero" aria-label="Microblading Zaragoza">
  <div class="page-hero-bg" style="background-image:url('/img/microblading-zaragoza-ent.gif');background-size:cover"></div>
  <div class="container">
  ...
  <div class="container">
    <div class="content-grid">
      <div class="content-text reveal">
        ...
        <a href="/contacto.php" class="btn btn--primary">¿Es el microblading para ti? Cuéntame</a>
      </div>
      <div class="content-img reveal reveal-delay-1">
        <img src="/img/microblading-proceso.jpg"
    ...
    <div style="display:grid;grid-template-columns:1fr 1fr;gap:32px;margin-top:48px">
      <div class="reveal" style="background:var(--white);border-radius:var(--radius-lg);padding:36px;border:1.5px solid var(--border)">
        ...
        <ul style="display:flex;flex-direction:column;gap:14px">
          ...
          <li style="display:flex;gap:12px"><span style="color:var(--text-light);flex-shrink:0">·</span> Duración: 1-3 años según piel</li>
          <li style="display:flex;gap:12px"><span style="color:var(--text-light);flex-shrink:0">·</span> Puede difuminar antes en pieles grasas</li>
        </ul>
      </div>
      <div class="reveal reveal-delay-1" style="background:var(--champagne);border-radius:var(--radius-lg);padding:36px;border:1.5px solid var(--nude)">
        ...
        <ul style="display:flex;flex-direction:column;gap:14px">
          ...
          <li style="display:flex;gap:12px"><span style="color:var(--text-light);flex-shrink:0">·</span> Duración: 1-3 años con retoques</li>
          <li style="display:flex;gap:12px"><span style="color:var(--text-light);flex-shrink:0">·</span> Permite técnicas combinadas (sombreado)</li>
        </ul>
      </div>
    </div>
  </div>
...
<section class="section" style="background:var(--white)">
  <div class="container">
    ...
    <div class="gallery-grid" style="margin-top:40px">
      ...
      foreach ($microblading_imgs as $img): ?>
        <div class="gallery-item reveal">
          <img src="/img/trabajos/cejas/<?= htmlspecialchars($img[0]) ?>"
               alt="<?= htmlspecialchars($img[1]) ?>"
               loading="lazy">
      ...
      <div class="faq-item">
        ...
        <div class="faq-answer">
          <p>
            ...
            sí se puede trabajar encima, en otros hay que esperar a que se desvanezcca más.
  ...
  <div class="container">
    <div class="reveal">
      ...
      <div class="cta-actions">
        ...
        <a href="/contacto.php" class="btn btn--white">Formulario</a>
      </div>
    </div>
  </div>
</section>
