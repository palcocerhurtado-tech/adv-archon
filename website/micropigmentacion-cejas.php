<?php
$pageTitle    = 'Micropigmentación de Cejas Zaragoza — Virginia Aguilera | Pelo a pelo y Microblading';
$pageDesc     = 'Micropigmentación de cejas en Zaragoza: pelo a pelo, combinada y microblading. Diseño personalizado, resultado natural. Primera valoración gratuita. 620 834 002.';
$pageKeywords = 'micropigmentación cejas Zaragoza, microblading Zaragoza, cejas pelo a pelo Zaragoza, cejas permanentes Zaragoza, diseño cejas Zaragoza';
$pageImage    = 'https://micropigmentacionzgz.es/img/micropigmentacion-cejas.jpg';
$canonicalUrl = 'https://micropigmentacionzgz.es/micropigmentacion-cejas.php';
include 'includes/header.php';
?>

<!-- PAGE HERO -->
<section class="page-hero" aria-label="Micropigmentación de cejas">
  <div class="page-hero-bg" style="background-image:url('/img/banner-cejas-lateral.jpg')"></div>
  <div class="container">
  ...
  <div class="container">
    <div class="content-grid">
      <div class="content-text reveal">
        ...
        <a href="/contacto.php" class="btn btn--primary">Pide tu valoración gratuita</a>
      </div>
  ...
  <div class="container">
    <div class="content-grid reverse">
      <div class="content-img reveal">
        <img src="/img/trabajos/cejas/microblading-cejas-zaragoza3.jpg"
      ...
      <div class="content-text reveal reveal-delay-1">
        ...
        <a href="/contacto.php" class="btn btn--primary">Cuéntame tu caso</a>
      </div>
    </div>
  </div>
</section>
