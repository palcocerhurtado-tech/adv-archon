<?php
$pageTitle    = 'Micropigmentación de Labios Zaragoza — Contorno y Color Natural | Virginia Aguilera';
$pageDesc     = 'Micropigmentación de labios en Zaragoza: contorno definido, color natural, aspecto rejuvenecido. Con anestesia, molestias mínimas. Primera consulta gratuita. 620 834 002.';
$pageKeywords = 'micropigmentación labios Zaragoza, labios permanentes Zaragoza, contorno labios Zaragoza, perfilado labios Zaragoza, labios aquarelle Zaragoza';
$pageImage    = 'https://micropigmentacionzgz.es/img/micropigmentacion-labios.jpg';
$canonicalUrl = 'https://micropigmentacionzgz.es/micropigmentacion-labios.php';
include 'includes/header.php';
?>

<!-- PAGE HERO -->
<section class="page-hero" aria-label="Micropigmentación de labios">
  <div class="page-hero-bg" style="background-image:url('/img/banner-labios-lateral.jpg')"></div>
  <div class="container">
  ...
  <div class="container">
    <div class="content-grid">
      <div class="content-text reveal">
        ...
        <a href="/contacto.php" class="btn btn--primary">Reserva tu cita</a>
      </div>
      <div class="content-img reveal reveal-delay-1">
        <img src="/img/micropigmentacion-labios.jpg"
...
<section class="section" style="background:var(--white)">
  <div class="container">
    ...
    <div class="gallery-grid" style="margin-top:40px">
      ...
      foreach ($labios_imgs as $img): ?>
        <div class="gallery-item reveal">
          <img src="/img/trabajos/labios/<?= htmlspecialchars($img[0]) ?>"
    ...
    <div class="gallery-cta reveal">
      <a href="/trabajos-cejas.php#labios" class="btn btn--outline">Ver todos los trabajos de labios</a>
    </div>
  </div>
</section>
