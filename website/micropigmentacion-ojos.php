<?php
$pageTitle    = 'Micropigmentación de Ojos Zaragoza — Eyeliner Permanente | Virginia Aguilera';
$pageDesc     = 'Eyeliner permanente en Zaragoza: tribal, sombreado, fuzzy, eyecolor. Una mirada definida sin maquillarte cada mañana. Primera consulta gratuita. 620 834 002.';
$pageKeywords = 'micropigmentación ojos Zaragoza, eyeliner permanente Zaragoza, delineado permanente Zaragoza, micropigmentación párpados Zaragoza';
$pageImage    = 'https://micropigmentacionzgz.es/img/micropigmentacion-ojos.jpg';
$canonicalUrl = 'https://micropigmentacionzgz.es/micropigmentacion-ojos.php';
include 'includes/header.php';
?>

<!-- PAGE HERO -->
<section class="page-hero" aria-label="Micropigmentación de ojos">
  <div class="page-hero-bg" style="background-image:url('/img/banner-ojos-lateral.jpg')"></div>
  <div class="container">
  ...
  <div class="container">
    <div class="content-grid">
      <div class="content-text reveal">
        ...
        <a href="/contacto.php" class="btn btn--primary">¿Te lo cuento todo? Escríbeme</a>
      </div>
      <div class="content-img reveal reveal-delay-1">
        <img src="/img/micropigmentacion-ojos.jpg"
