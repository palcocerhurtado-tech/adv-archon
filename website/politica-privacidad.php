<?php
$pageTitle    = 'Política de Privacidad — Virginia Aguilera Micropigmentación Zaragoza';
$pageDesc     = 'Política de privacidad y tratamiento de datos personales del sitio web de Virginia Aguilera, especialista en micropigmentación en Zaragoza.';
$canonicalUrl = 'https://micropigmentacionzgz.es/politica-privacidad.php';
...
<section style="padding:140px 0 80px">
  <div class="container" style="max-width:740px">
    ...
    <h2>Legitimación</h2>
    <p>El tratamiento se basa en el consentimiento que otorgas al marcar la casilla de aceptación y enviar el formulario.</p>

    <h2>Conservación</h2>
    <p>Los datos se conservarán durante el tiempo necesario para responder a tu consulta y, en su caso, mientras exista una relación profesional contigo. Después serán eliminados de forma segura.</p>
