  ...
  <div class="container">
    <div class="about-hero">
      ...
      <div class="about-text reveal reveal-delay-1">
        ...
        <a href="/contacto.php" class="btn btn--primary" style="margin-top:8px">Ven a conocerme — primera consulta gratuita</a>
      </div>
...
<!-- CREDENCIALES - presentadas de forma natural -->
    ...
    <div class="content-grid">
      ...
      <div class="reveal reveal-delay-1" style="display:flex;flex-direction:column;gap:20px">
        <div style="border-radius:var(--radius-lg);overflow:hidden;box-shadow:var(--shadow)">
          <img src="/img/diploma-micropigmentacion.jpg"
               alt="Diploma formación micropigmentación Virginia Aguilera"
               loading="lazy">
        </div>
        <div style="display:grid;grid-template-columns:1fr 1fr;gap:16px">
          <div style="border-radius:var(--radius-lg);overflow:hidden;box-shadow:var(--shadow)">
            <img src="/img/sello-de-calidad-negro.png"
