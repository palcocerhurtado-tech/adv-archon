<?php
$pageTitle    = 'Galería de Trabajos — Micropigmentación Zaragoza | Cejas, Ojos y Labios';
$pageDesc     = 'Resultados reales de micropigmentación de cejas, ojos y labios en Zaragoza. Cada caso es único. Galería de trabajos de Virginia Aguilera.';
$pageKeywords = 'galería micropigmentación Zaragoza, antes y después micropigmentación, trabajos microblading Zaragoza, resultados micropigmentación cejas';
$pageImage    = 'https://micropigmentacionzgz.es/img/trabajos/cejas/microblading-cejas-zaragoza2.jpg';
$canonicalUrl = 'https://micropigmentacionzgz.es/trabajos-cejas.php';
...
<section class="page-hero" aria-label="Galería de trabajos">
  <div class="page-hero-bg" style="background-image:url('/img/trabajos/cejas/microblading-cejas-zaragoza2.jpg')"></div>
  <div class="container">
...
<section class="section">
  <div class="container">
    ...
    <div class="masonry-grid">
      <?php foreach ($trabajos_cejas as $img): ?>
      ...
      <?php foreach ($trabajos_ojos as $img): ?>
        <div class="masonry-item reveal" data-cat="ojos">
          <img src="/img/trabajos/ojos/<?= htmlspecialchars($img[0]) ?>"
               alt="<?= htmlspecialchars($img[1]) ?>"
               loading="lazy">
      ...
      <?php foreach ($trabajos_labios as $img): ?>
  ...
  <div class="container">
    <div class="reveal">
      ...
      <div class="cta-actions">
        ...
        <a href="/contacto.php" class="btn btn--white">Contacto</a>
      </div>
    </div>
  </div>
</section>
