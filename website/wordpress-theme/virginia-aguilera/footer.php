  ...
  <div class="container">
    <div class="footer-grid">
      ...
      <div class="footer-brand">
        <img src="<?php echo get_template_directory_uri(); ?>/img/logotipo-micropigmentacion-virginia.png"
             alt="Virginia Aguilera Micropigmentación"
             class="footer-logo"
      ...
      <div class="footer-col">
        <h5>Servicios</h5>
        <ul>
          <li><a href="<?php echo home_url('/micropigmentacion-cejas/'); ?>">Micropigmentación de cejas</a></li>
          <li><a href="<?php echo home_url('/micropigmentacion-ojos/'); ?>">Micropigmentación de ojos</a></li>
          <li><a href="<?php echo home_url('/micropigmentacion-labios/'); ?>">Micropigmentación de labios</a></li>
          <li><a href="<?php echo home_url('/microblading-zaragoza/'); ?>">Microblading en Zaragoza</a></li>
        </ul>
      </div>
      ...
      <div class="footer-col">
        <h5>Estudio</h5>
        <ul>
          <li><a href="<?php echo home_url('/virginia/'); ?>">Virginia Aguilera</a></li>
          <li><a href="<?php echo home_url('/trabajos/'); ?>">Galería de trabajos</a></li>
      ...
      <div class="footer-col">
        <h5>Contacto</h5>
        <p>
          <strong style="color:rgba(255,255,255,0.8)">CC El Caracol</strong><br>
          Pº Independencia 24-26<br>Planta -1, Local 72<br>Zaragoza
        </p>
        <p style="margin-top:14px">
          <strong style="color:rgba(255,255,255,0.8)">Hospital Viamed Montecanal</strong><br>
          C/ Franz Schubert 2<br>50012 Zaragoza
        </p>
        <p style="margin-top:14px">
          <a href="tel:+34620834002" style="color:var(--gold);font-weight:600">620 834 002</a>
        </p>
      </div>
    ...
    <div class="footer-bottom">
      <p>&copy; <?php echo date('Y'); ?> Virginia Aguilera — Micropigmentación Zaragoza. Todos los derechos reservados.</p>
      <div>
        <a href="<?php echo home_url('/aviso-legal/'); ?>">Aviso legal</a> &nbsp;·&nbsp;
        <a href="<?php echo home_url('/politica-privacidad/'); ?>">Privacidad</a> &nbsp;·&nbsp;
        <a href="<?php echo home_url('/politica-cookies/'); ?>">Cookies</a>
      </div>
    </div>
  </div>
</footer>

<!-- Schema markup JSON-LD BeautySalon -->
<script type="application/ld+json">
{
  ...
  "image": "https://micropigmentacionzgz.es/img/virginia-aguilera-micropigmentacion.jpg",
  "priceRange": "€€",
  "legalName": "VIRLAJA SOCIEDAD LIMITADA",
  "taxID": "B56175797",
  "address": [
    {
      "@type": "PostalAddress",
      "streetAddress": "Paseo de la Independencia 24-26, Planta -1, Local 72 (CC El Caracol)",
  ...
  "sameAs": [
    "https://www.instagram.com/vir_micropigmentacion_zaragoza"
  ],
  "hasOfferCatalog": {
    "@type": "OfferCatalog",
